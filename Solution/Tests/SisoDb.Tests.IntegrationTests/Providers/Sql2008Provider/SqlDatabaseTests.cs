...
using SisoDb.Tests.IntegrationTests.Providers.Sql2008Provider.StructureSetUpdaterTests.ModelOld;
...
namespace SisoDb.Tests.IntegrationTests.Providers.Sql2008Provider
{
    ...
    public class SqlDatabaseTests : SqlIntegrationTestBase
    {
        ...
        protected override void OnTestFinalize()
        {
            ...
            Database.DropStructureSet<ItemForPropChange>();
        ...
        public void Exists_WhenItExists_ReturnsTrue()
        {
            ...
            var db = new Sql2008Database(_connectionInfoForTempDb);
        ...
        private void AssertInitializedDbExists(Sql2008Database db)
        {
            var dbExists = db.Exists();
            Assert.IsTrue(dbExists);
