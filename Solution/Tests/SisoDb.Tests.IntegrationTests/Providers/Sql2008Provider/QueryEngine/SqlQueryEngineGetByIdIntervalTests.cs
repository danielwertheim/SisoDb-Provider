...
namespace SisoDb.Tests.IntegrationTests.Providers.Sql2008Provider.QueryEngine
{
    [TestFixture]
    public class SqlQueryEngineGetByIdIntervalTests : SqlIntegrationTestBase
    {
        ...
        public void GetByIdInterval_ForIdentities_WhenNoItemsExists_ReturnsEmptyResult()
        {
            ...
            {
                var refetched = qe.GetByIdInterval<IdentityItem>(1, 3);
        ...
        public void GetByIdInterval_ForGuids_WhenNoItemsExists_ReturnsEmptyResult()
        {
            ...
            using (var qe = Database.CreateQueryEngine())
            {
                var refetched = qe.GetByIdInterval<GuidItem>(idFrom, idTo);
        ...
        public void GetByIdInterval_ForIdentities_WhenIntervalMatchesOnlyASubset_OnlySubsetIsReturned()
        {
            ...
            using(var qe = Database.CreateQueryEngine())
            {
                refetched = qe.GetByIdInterval<IdentityItem>(1, 3).ToList();
            }
