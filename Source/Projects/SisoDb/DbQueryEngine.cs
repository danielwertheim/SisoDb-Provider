...
namespace SisoDb
{
    public abstract class DbQueryEngine : IQueryEngine, IAdvancedQueryEngine
    {
            ...
            bool transactional)
        {
            ...
            ProviderFactory = SisoEnvironment.ProviderFactories.Get(db.ConnectionInfo.ProviderType);
            
            DbClient = transactional 
                ? ProviderFactory.GetTransactionalDbClient(db.ConnectionInfo) 
                : ProviderFactory.GetNonTransactionalDbClient(db.ConnectionInfo);
        ...
        {
            return Db.Serializer.DeserializeMany<T>(((IAdvancedQueryEngine)this).NamedQueryAsJson<T>(query));
        }

        IEnumerable<TOut> IAdvancedQueryEngine.NamedQueryAs<TContract, TOut>(INamedQuery query)
        {
            return Db.Serializer.DeserializeMany<TOut>(((IAdvancedQueryEngine)this).NamedQueryAsJson<TContract>(query));
        }
        ...
        {
            return Db.Serializer.Deserialize<T>(
                GetByIdAsJson<T>(id));
        }
        ...
        public virtual TOut GetByIdAs<TContract, TOut>(object id)
            ...
            where TOut : class
        {
            return Db.Serializer.Deserialize<TOut>(
        ...
        public virtual IEnumerable<T> GetAll<T>() where T : class
        {
            ...
            return Db.Serializer.DeserializeMany<T>(GetAllAsJson<T>(command));
        }
        ...
        public virtual IEnumerable<T> GetAll<T>(Action<IGetCommandBuilder<T>> commandInitializer) where T : class
        {
            ...
            return Db.Serializer.DeserializeMany<T>(GetAllAsJson<T>(commandBuilder.Command));
        }
        ...
        public virtual IEnumerable<TOut> GetAllAs<TContract, TOut>()
            ...
            where TOut : class
        {
            return Db.Serializer.DeserializeMany<TOut>(GetAllAsJson<TContract>());
        }
            ...
            where TOut : class
        {
            ...
            return Db.Serializer.DeserializeMany<TOut>(GetAllAsJson<TContract>(commandBuilder.Command));
        }
            ...
            where T : class
        {
            ...
            return Db.Serializer.DeserializeMany<T>(QueryAsJson(commandBuilder.Command));
        }
        ...
        public virtual IEnumerable<TOut> QueryAs<TContract, TOut>(Action<IQueryCommandBuilder<TContract>> commandInitializer)
            ...
            where TOut : class
        {
            var structureSchema = Db.StructureSchemas.GetSchema(TypeFor<TContract>.Type);
            UpsertStructureSet(structureSchema);

            var commandBuilder = ProviderFactory.CreateQueryCommandBuilder<TContract>(structureSchema);
            commandInitializer(commandBuilder);

            return Db.Serializer.DeserializeMany<TOut>(QueryAsJson(commandBuilder.Command));
        }
