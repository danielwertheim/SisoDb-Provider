...
namespace SisoDb.SqlCe4.Dac
{
    public class SqlCe4DbClient : DbClientBase
    {
        ...
        public SqlCe4DbClient(ISisoConnectionInfo connectionInfo, IDbConnection connection, ISisoDbDatabaseTransaction transaction, IConnectionManager connectionManager, ISqlStatements sqlStatements)
        ...
        {
            return new SqlCe4DbBulkCopy((SqlCeConnection)Connection, (SqlCeTransaction)Transaction.InnerTransaction);
        }
        ...
        public override void ExecuteNonQuery(string sql, params IDacParameter[] parameters)
        {
            if (!sql.Contains(";"))
                ...
                Connection.ExecuteNonQuery(sql.Split(';'), GetDbTransaction(), parameters);
        }
