...
namespace SisoDb.UnitTests.DbSchema
{
    ...
    public class IndexStorageSchemaTests : StorageSchemaTestBase
    {
        ...
        public void OrderedFields_ShouldBeReturnedInCorrectSequenece()
        {
            ...
            Assert.AreEqual(IndexStorageSchema.Fields.RowId, fields[0]);
            Assert.AreEqual(IndexStorageSchema.Fields.StructureId, fields[1]);
            Assert.AreEqual(IndexStorageSchema.Fields.MemberPath, fields[2]);
            Assert.AreEqual(IndexStorageSchema.Fields.Value, fields[3]);
            Assert.AreEqual(IndexStorageSchema.Fields.StringValue, fields[4]);
        }
