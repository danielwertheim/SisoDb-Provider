...
namespace SisoDb.UnitTests.Querying.Lambdas.Parsers
{
    ...
    public class WhereParserCommunitySupportTests : UnitTestBase
    {
        ...
        public void Parse_When_StringQxStartsWith_or_IntEquals_or_ListOfStringsQxAny__ReturnsCorrectNodes()
        {
            ...
            Assert.AreEqual(typeof(string), listOfNodes[2].CastAs<MemberNode>().MemberType);
            ...
            Assert.AreEqual(typeof(int), listOfNodes[6].CastAs<MemberNode>().MemberType);
            ...
            Assert.AreEqual(typeof(string), listOfNodes[11].CastAs<MemberNode>().MemberType);
