...
{
    [TestFixture]
    public class ParsedSelectorLambdaSqlProcessorFunctionInvocationTests : ParsedSelectorLambdaSqlProcessorTestBase
    {
        [Test]
        ...
        {
            var parsedLambda = CreateParsedLambda<MyItem>(i => i.DateTime1 == DateTime.Parse("2010-11-12", SisoDbEnvironment.DateTimeFormatProvider));
        ...
        public void Process_WhenInstanceFunction_GeneratesCorrectSqlQuery()
        {
            ...
            var parsedLambda = CreateParsedLambda<MyItem>(i => i.String1 == dateTime.ToString(SisoDbEnvironment.DateTimeFormatProvider));
