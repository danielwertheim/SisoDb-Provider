...
namespace SisoDb.Specifications.Session.Querying.StringFunctions
{
    namespace ToUpper
    {
        ...
        //    Because of = 
        //        () => _fetchedStructures = TestContext.Database.UseOnceTo().Where<StringFunctionsItem>(i => i.String1.ToUpper() == "foo1").ToList();
        ...
        public class when_applied_on_inline_value_and_matches_subset_of_2_items : SpecificationBase
        {
            ...
            Because of =
                () => _fetchedStructures = TestContext.Database.UseOnceTo()
                    .Query<StringFunctionsItem>().Where(i => i.String1.ToUpper() == "efg2".ToUpper() || i.String1.ToUpper() == "efg3".ToUpper()).ToList();
