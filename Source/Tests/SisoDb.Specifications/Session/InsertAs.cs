...
namespace SisoDb.Specifications.Session
{
    class InsertAs
    {
        ...
        public class when_inserting_anonymous_that_partially_conforms_to_contract_using_type : SpecificationBase
        {
            Establish context = () =>
            {
            ...
            Because of = () =>
            {
                ...
                TestContext.Database.UseOnceTo().InsertAs(typeof(Model), item);
            };
