    ...
    namespace UpdateStructureSet
    {
        ...
        public class when_two_structures_exists_and_abort_is_made_on_last : SpecificationBase
        {
            ...
            Because of = () =>
                ...
                (oldItem, newItem) =>
                {
                    ...
                    if (oldItem.StructureId == _orgItem2Id)
                        return StructureSetUpdaterStatuses.Abort;
            ...
            It should_have_kept_old_items_untouched = () =>
            {
                ...
                List<ModelOld.GuidItemForPropChange> items;

                using (var q = TestContext.Database.CreateQueryEngine())
                {
                    items = q.GetAll<ModelOld.GuidItemForPropChange>().ToList();
                }
        ...
        public class when_the_second_of_two_new_structures_does_not_get_an_identity_id : SpecificationBase
        {
            ...
            It should_have_kept_old_items_untouched = () =>
            {
                ...
                List<ModelOld.ItemForPropChange> items;

                using (var q = TestContext.Database.CreateQueryEngine())
                {
                    items = q.GetAll<ModelOld.ItemForPropChange>().ToList();
                }
