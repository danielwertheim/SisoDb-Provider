...
namespace SisoDb.Specifications.Database
{
    namespace DropStructureSets
    {
        ...
        public class when_two_different_sets_exists : SpecificationBase
        {
            ...
            It should_have_dropped_first_sets_indexes_table =
                () => TestContext.DbHelper.TableExists(_structureSchema1.GetIndexesTableName()).ShouldBeFalse();
            ...
            It should_have_dropped_second_sets_indexes_table =
                () => TestContext.DbHelper.TableExists(_structureSchema2.GetIndexesTableName()).ShouldBeFalse();
