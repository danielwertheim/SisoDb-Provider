...
namespace SisoDb.Specifications.QueryEngine.StringFunctions
{
    namespace QxToUpper
    {
        ...
        //    Because of = 
        //        () => _fetchedStructures = TestContext.Database.ReadOnce().Where<StringFunctionsItem>(i => i.String1.QxToUpper() == "foo1").ToList();
        ...
        [Subject(typeof(IQueryEngine), "QxToUpper")]
        public class when_query_matches_subset_of_2_items : SpecificationBase
        {
            ...
            Because of =
                () => _fetchedStructures = TestContext.Database.ReadOnce().Where<StringFunctionsItem>(
                    i => i.String1.QxToUpper() == "EFG2" || i.String1.QxToUpper() == "EFG3").ToList();
