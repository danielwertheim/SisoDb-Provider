...
namespace SisoDb.Specifications.Sql2008.UnitOfWork
{
    namespace InsertsOfUniquesPerType
    {
        ...
        public class when_inserting_one_unique_per_type_guid_entity : SpecificationBase
        {
            ...
            Because of = () => _structure = TestContext.Database.Insert(new VehicleWithGuidId { VehRegNo = "ABC123" });
        ...
        public class when_inserting_two_unique_per_type_guid_entities : SpecificationBase
        {
            ...
            Because of = () => _structures = TestContext.Database.InsertMany(new[]
            {
        ...
        public class when_inserting_two_non_unique_per_type_guid_entities : SpecificationBase
        {
            Establish context = () =>
            {
                ...
                _orgStructure = TestContext.Database.Insert(new VehicleWithGuidId { VehRegNo = "ABC123" });
            };

            Because of =
                () => CaughtException = Catch.Exception(() => TestContext.Database.Insert(new VehicleWithGuidId { VehRegNo = "ABC123" }));
        ...
        public class when_inserting_one_unique_per_type_identity_entity : SpecificationBase
        {
            ...
            Because of = () => _structure = TestContext.Database.Insert(new VehicleWithIdentityId { VehRegNo = "ABC123" });
        ...
        public class when_inserting_two_non_unique_per_type_identity_entities : SpecificationBase
        {
            Establish context = () =>
            {
                ...
                _orgStructure = TestContext.Database.Insert(new VehicleWithIdentityId { VehRegNo = "ABC123" });
            };

            Because of =
                () => CaughtException = Catch.Exception(() => TestContext.Database.Insert(new VehicleWithIdentityId { VehRegNo = "ABC123" }));
        ...
        public class when_inserting_one_unique_per_type_big_identity_entity : SpecificationBase
        {
            ...
            Because of = () => _structure = TestContext.Database.Insert(new VehicleWithBigIdentityId { VehRegNo = "ABC123" });
        ...
        public class when_inserting_two_non_unique_per_type_big_identity_entities : SpecificationBase
        {
            Establish context = () =>
            {
                ...
                _orgStructure = TestContext.Database.Insert(new VehicleWithBigIdentityId { VehRegNo = "ABC123" });
            };

            Because of =
                () => CaughtException = Catch.Exception(() => TestContext.Database.Insert(new VehicleWithBigIdentityId { VehRegNo = "ABC123" }));
