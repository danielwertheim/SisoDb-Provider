...
namespace SisoDb.Specifications.Sql2008.QueryEngine
{
    namespace Where
    {
        [Subject(typeof(Sql2008QueryEngine), "Where")]
        ...
        [Subject(typeof(Sql2008QueryEngine), "Where as Json")]
        ...
        [Subject(typeof(Sql2008QueryEngine), "Where as X")]
        ...
        [Subject(typeof(Sql2008QueryEngine), "Where (nested items)")]
        ...
        [Subject(typeof(Sql2008QueryEngine), "Where as Json (nested items)")]
        ...
        [Subject(typeof(Sql2008QueryEngine), "Where as X (nested items)")]
