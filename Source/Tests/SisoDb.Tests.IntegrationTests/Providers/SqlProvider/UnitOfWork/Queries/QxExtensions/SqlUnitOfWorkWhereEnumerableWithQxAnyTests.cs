...
{
    [TestFixture]
    public class SqlUnitOfWorkWhereEnumerableWithQxAnyTests : IntegrationTestBase
    {
        ...
        public void QueryStringArrayUsingQxAny_MatchingFirstElementInArray_ItemIsReturned()
        {
            ...
            using (var uow = Database.CreateUnitOfWork())
            {
                refetched = uow.Where<QxItemForQueries>(i => i.Strings.QxAny(e => e == "Alpha")).SingleOrDefault();
            }
        ...
        public void QueryStringArrayUsingQxAny_SecondCriteriaMatchesMiddleElementInArray_ItemIsReturned()
        {
            ...
            using (var uow = Database.CreateUnitOfWork())
            {
                refetched = uow.Where<QxItemForQueries>(i => i.Strings.QxAny(e => e == "Temp" || e == "Bravo")).SingleOrDefault();
            }
        ...
        public void QueryIntArrayUsingQxAny_MatchingFirstElementInArray_ItemIsReturned()
        {
            ...
            using (var uow = Database.CreateUnitOfWork())
            {
                refetched = uow.Where<QxItemForQueries>(i => i.Integers.QxAny(e => e == 1)).SingleOrDefault();
            }
        ...
        public void QueryIntArrayUsingQxAny_SecondCriteriaMatchesMiddleElementInArray_ItemIsReturned()
        {
            ...
            using (var uow = Database.CreateUnitOfWork())
            {
                refetched = uow.Where<QxItemForQueries>(i => i.Integers.QxAny(e => e == -1 || e == 2)).SingleOrDefault();
            }
        ...
        public void QueryStringListUsingQxAny_MatchingFirstElementInList_ItemIsReturned()
        {
            ...
            using (var uow = Database.CreateUnitOfWork())
            {
                refetched = uow.Where<QxItemForQueries>(i => i.StringList.QxAny(e => e == "Alpha")).SingleOrDefault();
            }
        ...
        public void QueryStringListUsingQxAny_SecondCriteriaMatchesMiddleElementInList_ItemIsReturned()
        {
            ...
            using (var uow = Database.CreateUnitOfWork())
            {
                refetched = uow.Where<QxItemForQueries>(i => i.StringList.QxAny(e => e == "Temp" || e == "Bravo")).SingleOrDefault();
            }
        ...
        public void QueryDecimalListUsingQxAny_MatchingFirstElementInList_ItemIsReturned()
        {
            ...
            using (var uow = Database.CreateUnitOfWork())
            {
                refetched = uow.Where<QxItemForQueries>(i => i.DecimalList.QxAny(e => e == 0.13M)).SingleOrDefault();
            }
        ...
        public void QueryDecimalListUsingQxAny_SecondCriteriaMatchesMiddleElementInList_ItemIsReturned()
        {
            ...
            using (var uow = Database.CreateUnitOfWork())
            {
                refetched = uow.Where<QxItemForQueries>(i => i.DecimalList.QxAny(e => e == -100 || e == 0.13M)).SingleOrDefault();
            }
        ...
        public void QueryChildItemListUsingQxAny_MatchingPropOfFirstElementInList_ItemIsReturned()
        {
            ...
            using (var uow = Database.CreateUnitOfWork())
            {
                refetched = uow.Where<QxItemForQueries>(i => i.ChildItemList.QxAny(e => e.Int == -42)).SingleOrDefault();
            }
        ...
        public void QueryChildItemListUsingQxAny_SecondCriteriaMatchesMiddleElementInList_ItemIsReturned()
        {
            ...
            using (var uow = Database.CreateUnitOfWork())
            {
                refetched = uow.Where<QxItemForQueries>(i => i.ChildItemList.QxAny(e => e.Int == 0 || e.Int == 42)).SingleOrDefault();
            }
        ...
        public void QueryListOnChildItemListUsingQxAny_MatchingPropOfFirstElementInList_ItemIsReturned()
        {
            ...
            using (var uow = Database.CreateUnitOfWork())
            {
                refetched = uow.Where<QxItemForQueries>(i => i.ChildItemList.QxAny(e => e.IntegerList.QxAny(e2 => e2 == -1))).SingleOrDefault();
            }
        ...
        public void QueryListOnChildItemListUsingQxAny_SecondCriteriaMatchesMiddleElementInList_ItemIsReturned()
        {
            ...
            using (var uow = Database.CreateUnitOfWork())
            {
                refetched = uow.Where<QxItemForQueries>(i => i.ChildItemList.QxAny(e => e.IntegerList.QxAny(e2 => e2 == -100 || e2 == 1))).SingleOrDefault();
            }
        ...
        public void QueryGrandChildtemListUsingQxAny_MatchingPropOfFirstElementInList_ItemIsReturned()
        {
            ...
            using (var uow = Database.CreateUnitOfWork())
            {
                refetched = uow.Where<QxItemForQueries>(i => i.ChildItemList.QxAny(e => e.GrandChildItemList.QxAny(e2 => e2.Int == -1))).SingleOrDefault();
            }
        ...
        public void QueryGrandChildtemListUsingQxAny_SecondCriteriaMatchesMiddleElementInList_ItemIsReturned()
        {
            ...
            using (var uow = Database.CreateUnitOfWork())
            {
                refetched = uow.Where<QxItemForQueries>(i => i.ChildItemList.QxAny(e => e.GrandChildItemList.QxAny(e2 => e2.Int == -100 || e2.Int == 1))).SingleOrDefault();
            }
