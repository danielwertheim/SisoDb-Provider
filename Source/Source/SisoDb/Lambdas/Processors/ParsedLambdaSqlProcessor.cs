...
{
    internal class ParsedLambdaSqlProcessor : IParsedLambdaProcessor<ISqlQuery>
    {
        private readonly IMemberNameGenerator _memberNameGenerator;

        public ParsedLambdaSqlProcessor(IMemberNameGenerator memberNameGenerator)
        {
            _memberNameGenerator = memberNameGenerator;
        }

        public ISqlQuery Process(IParsedLambda lambda)
        {
            ...
            return new SqlQuery(sql.ToString(), queryParams);
        }
    }
}