...
{
    internal class ParsedSelectorLambdaSqlProcessor : IParsedLambdaProcessor<ISqlSelector>
    {
        private readonly IMemberNameGenerator _memberNameGenerator;

        public ParsedSelectorLambdaSqlProcessor(IMemberNameGenerator memberNameGenerator)
        {
