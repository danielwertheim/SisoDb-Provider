...
{
    internal class ParsedSortingLambdaSqlProcessor : IParsedLambdaProcessor<ISqlSorting>
    {
        private readonly IMemberNameGenerator _memberNameGenerator;

        public ParsedSortingLambdaSqlProcessor(IMemberNameGenerator memberNameGenerator)
        {
